...
*/
    ...
    const onSubmitReset=(e)=>{
        ...
        formData.append('userPhone', state.phone);
        formData.append('userPw', state.newPw);
        axios({
            url: 'http://pse990813.dothome.co.kr/kurly_green/kurly_pw_reset.php',
            method: 'POST',
            data: formData
        })
        .then((res)=>{
    ...
    return (
        <main id='pw-reset-form' className='pw-reset-form'>
            <section id="section1">
                <div className="container">
                    <div className="title">
                        <h2 className='title-txt'>비밀번호 재설정</h2>
                    </div>
