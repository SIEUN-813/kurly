...
export default function Sub7AdminSignUpComponent() {
    ...
    const onClickIdBtn=(e)=>{
        ...
        if(regexp2.test(value) === false || regexp3.test(value) === true || regexp4.test(value) === true || regexp5.test(value) === false){         
            ...
            axios({
                url: 'http://pse990813.dothome.co.kr/kurly_green/kurly_admin_id_duplicate_check.php',
                method: 'POST',
                data: formData
            })
            .then((res)=>{
    ...
    const onClickEmailBtn=(e)=>{
        ...
        if(value === ''){
            ...
            axios({
                url: 'http://pse990813.dothome.co.kr/kurly_green/kurly_admin_email_duplicate_check.php',
                method: 'POST',
                data: formData
            })
            .then((res)=>{
    ...
    const onSubmitSignUpForm=(e)=>{
        ...
        if(state.id === ''){            
            ...
            axios({
                url: 'http://pse990813.dothome.co.kr/kurly_green/kurly_admin_signUp.php',
                method: 'POST',
                data: formData 
            })
            .then((res)=>{
